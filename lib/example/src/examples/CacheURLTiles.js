...
class CustomTiles extends react_1.default.Component {
    ...
    render() {
        ...
        <react_native_maps_1.default provider={this.props.provider} mapType={this.mapType} style={styles.map} initialRegion={region}>
          <react_native_maps_1.UrlTile urlTemplate="https://stamen-tiles.a.ssl.fastly.net/toner/{z}/{x}/{y}.png" zIndex={-1} 
        // Test steps:
        ...
        tileCacheMaxAge={20} doubleTileSize={true} opacity={1.0}/>
        </react_native_maps_1.default>
        <react_native_1.View style={styles.buttonContainer}>
          <react_native_1.View style={styles.bubble}>
            <react_native_1.Text>Cached URLTiles</react_native_1.Text>
          </react_native_1.View>
        </react_native_1.View>
      </react_native_1.View>);
    }
