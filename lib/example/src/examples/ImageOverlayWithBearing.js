...
class ImageOverlayWithBearing extends react_1.Component {
    constructor(props) {
        super(props);
        this.state = {
            region: {
    ...
    render() {
        ...
        <react_native_maps_1.default provider={this.props.provider} style={styles.map} initialRegion={this.state.region}>
          <react_native_maps_1.Overlay bounds={this.state.overlay1.bounds} bearing={30} image={this.state.overlay1.image}/>
          <react_native_maps_1.Overlay bounds={this.state.overlay2.bounds} bearing={-30} image={this.state.overlay2.image}/>
        </react_native_maps_1.default>
      </react_native_1.View>);
    }
}
exports.default = ImageOverlayWithBearing;
