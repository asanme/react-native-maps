...
const SPACE = 0.01;
class LoadingMap extends react_1.default.Component {
    constructor(props) {
        super(props);
        this.state = {
            region: {
    ...
    render() {
        ...
        <react_native_maps_1.default provider={this.props.provider} style={styles.map} initialRegion={this.state.region} loadingEnabled loadingIndicatorColor="#666666" loadingBackgroundColor="#eeeeee">
          ...
          <react_native_maps_1.Marker coordinate={{
                latitude: LATITUDE - SPACE,
                longitude: LONGITUDE - SPACE,
            }} centerOffset={{ x: -42, y: -60 }} anchor={{ x: 0.84, y: 1 }}>
        ...
        <react_native_1.View style={styles.buttonContainer}>
          <react_native_1.View style={styles.bubble}>
            <react_native_1.Text>Map with Loading</react_native_1.Text>
          </react_native_1.View>
        </react_native_1.View>
      </react_native_1.View>);
    }
