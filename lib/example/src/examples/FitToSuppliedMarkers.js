...
class FocusOnMarkers extends react_1.default.Component {
    map;
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        <react_native_maps_1.default provider={this.props.provider} ref={ref => {
          ...
          <react_native_maps_1.Marker identifier="Marker1" coordinate={this.state.a}/>
          <react_native_maps_1.Marker identifier="Marker2" coordinate={this.state.b}/>
          <react_native_maps_1.Marker identifier="Marker3" coordinate={this.state.c}/>
          <react_native_maps_1.Marker identifier="Marker4" coordinate={this.state.d}/>
          <react_native_maps_1.Marker identifier="Marker5" coordinate={this.state.e}/>
...
exports.default = FocusOnMarkers;
