...
class ViewsAsMarkers extends react_1.default.Component {
    constructor(props) {
        super(props);
        this.state = {
            region: {
    ...
    render() {
        ...
        <react_native_maps_1.default provider={this.props.provider} style={styles.map} initialRegion={this.state.region}>
          <react_native_maps_1.Marker coordinate={this.state.coordinate}>
            <PriceMarker_1.default amount={this.state.amount}/>
...
exports.default = ViewsAsMarkers;
